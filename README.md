...
- Copilot agents catalog: docs/COPILOT_AGENTS_README.md
- Copilot custom agents: docs/COPILOT_CUSTOM_AGENTS.md
...
- Copilot Agent day-1 checklist: docs/COPILOT_AGENT_WORKFLOW.md#02-day-1-5-minute-checklist
